    ...
    describe('convert', () => {
        ...
        describe('invalid Keys', () => {
            ...
            it('should remove deeply nested keys that do not feature in the validFields array', async function() {
                ...
                expect(result.schemas.basic).to.not.have.property('$schema')
                expect(result.schemas.basic.properties.errors).to.not.have.property('$schema')
        ...
        describe('properties as null', () => {
            it('should convert properties as null to nullable', async function() {
                ...
                const result = newConvertor.convert('basic')
                expect(result.schemas.basic.properties.nullProperty).to.not.have.property('type')
                expect(result.schemas.basic.properties.nullProperty).to.have.property('nullable')
                expect(result.schemas.basic.properties.nullProperty.nullable).to.be.equal(true)
        ...
        describe('arrays of types', () => {
            it('should convert properties that have an array of types to a oneOf', async function() {
                ...
                const result = newConvertor.convert('basic')
                expect(result.schemas.basic.properties.arrayTypeProperty).to.not.have.property('type')
                expect(result.schemas.basic.properties.arrayTypeProperty).to.have.property('oneOf')
                expect(result.schemas.basic.properties.arrayTypeProperty.oneOf).to.be.an('array')
                expect(result.schemas.basic.properties.arrayTypeProperty.oneOf.length).to.be.equal(2)
            ...
            it('should convert properties that have an array of types to a oneOf with null fields', async function() {
                ...
                expect(result.schemas.basic.properties.arrayTypeProperty).to.have.property('oneOf')
                expect(result.schemas.basic.properties.arrayTypeProperty.oneOf).to.be.an('array')
                expect(result.schemas.basic.properties.arrayTypeProperty.oneOf.length).to.be.equal(1)
                expect(result.schemas.basic.properties.arrayTypeProperty.oneOf[0].type).to.be.equal('string')
                expect(result.schemas.basic.properties.arrayTypeProperty.oneOf[0].nullable).to.be.equal(true)
        ...
        describe('default values', () => {
            it('should convert default Array values correctly', async function() {
                ...
                const result = newConvertor.convert('basic')
                expect(result.schemas.basic.properties.errors).to.have.property('default')
                expect(result.schemas.basic.properties.errors.default).to.be.an('array')
                expect(result.schemas.basic.properties.errors.default.length).to.be.equal(1)
                expect(result.schemas.basic.properties.errors.default[0]).to.be.equal(1)
                expect(result.schemas.basic.properties.other).to.have.property('items')
                expect(result.schemas.basic.properties.other.items).to.be.deep.equal({nullable: true})
            ...
            it('should convert default Boolean values correctly', async function() {
                ...
                const result = newConvertor.convert('basic')
                expect(result.schemas.basic.properties.errors).to.have.property('default')
                expect(result.schemas.basic.properties.errors.default).to.be.equal(true)
                expect(result.schemas.basic.properties.other).to.have.property('default')
                expect(result.schemas.basic.properties.other.default).to.be.equal(false)
        ...
        describe('const values', () => {
            it('should convert const values to enum', async function() {
                ...
                const result = newConvertor.convert('basic')
                expect(result.schemas.basic.properties.name).to.not.have.property('const')
                ...
                expect(result.schemas.basic.properties.name.enum[0]).to.be.equal('blah')
        ...
        describe('dependencies schemas', () => {
            it('should convert a dependencies as Array schema', async function() {
                ...
                expect(result.schemas.basic.properties).to.have.property('billing_address')
